...
<button type="submit" id="box"  name="alogin"  class="btn btn-outline-success space top btwn">ADMIN LOGIN</button>
    ...
    <div class="container" style="background-color:#f1f1f1; margin-left: 0px;">
      ...
      <span class="psw"> If don't have account? <a href="http://localhost:8081/rrsproject/register.jsp">&nbspSIGN UP</a>&nbsp|&nbsp<a href="http://localhost:8081/rrsproject/forgotpassword.jsp">Forgot password</a></span>
    </div>
  </form>
</div>
