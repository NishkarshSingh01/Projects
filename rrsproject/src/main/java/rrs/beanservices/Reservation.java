	...
	try
	{
		...
		else if(req.getParameter("reserve")!=null)
		{
			...
			else
			{
				...
				{				
					if((t.getTrainno()==trainno && t.getFromst().equals(fromst) && t.getTost().equals(tost) && t.getMon().equals(day))||(t.getTrainno()==trainno && t.getFromst().equals(fromst) && t.getTost().equals(tost) && t.getTues().equals(day)) ||
							(t.getTrainno()==trainno && t.getFromst().equals(fromst) && t.getTost().equals(tost) && t.getWed().equals(day)) ||(t.getTrainno()==trainno && t.getFromst().equals(fromst) && t.getTost().equals(tost) &&  t.getThur().equals(day))||
							(t.getTrainno()==trainno && t.getFromst().equals(fromst) && t.getTost().equals(tost) && t.getFri().equals(day)) ||(t.getTrainno()==trainno && t.getFromst().equals(fromst) && t.getTost().equals(tost) && t.getSat().equals(day)) || (t.getTrainno()==trainno && t.getFromst().equals(fromst) && t.getTost().equals(tost) && t.getSun().equals(day)))
					{
							if(classs.equals("AC"))
							{
						...
						{
							JOptionPane.showMessageDialog(null, "Reservation Failed","INFO",JOptionPane.INFORMATION_MESSAGE);
						}
						if(session.getAttribute("user")!=null && session.getAttribute("user").equals("User"))
						{
							RequestDispatcher rd=req.getRequestDispatcher("userloggedin.jsp");
					...
					{
						JOptionPane.showMessageDialog(null,"Given Train details are Wrong.");
						if(session.getAttribute("user")!=null && session.getAttribute("user").equals("User"))
						{
							RequestDispatcher rd=req.getRequestDispatcher("userloggedin.jsp");
							rd.forward(req, res);
		...
		else if(req.getParameter("reserved")!=null)
		{
			if(g.getReservation()!=null)
			{
				...
				{
					if(r.getEmail().equals(session.getAttribute("email")))
					{
				...
				{
					JOptionPane.showMessageDialog(null,"No reservation with this account.");
					if(session.getAttribute("user")!=null && session.getAttribute("user").equals("User"))
					{
						RequestDispatcher rd=req.getRequestDispatcher("userloggedin.jsp");
						rd.forward(req, res);
