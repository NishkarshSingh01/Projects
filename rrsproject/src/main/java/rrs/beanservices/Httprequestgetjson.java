...
public class Httprequestgetjson 
{
	...
	public List<loginbean> getLogin()
	{
		...
		loginlist.clear();
		String loginurl="http://localhost:8081/rrsproject/rrs/getapi/login"; 
	...
	List<registerbean> getRegister()
	{
		List<registerbean> registerlist=new ArrayList<registerbean>();
		registerlist.clear();
		
		String registerurl="http://localhost:8081/rrsproject/rrs/getapi/register";
	...
	List<modifytrainbean> getTrain()
	{
		List<modifytrainbean> trainlist=new ArrayList<modifytrainbean>();
		trainlist.clear();
		
		String trainurl="http://localhost:8081/rrsproject/rrs/getapi/train";
	...
	List<reservationbean> getReservation()
	{
		List<reservationbean> reservelist=new ArrayList<reservationbean>();
		reservelist.clear();
		
		String reservationurl="http://localhost:8081/rrsproject/rrs/getapi/reservation";
