...
public class Reservation extends HttpServlet 
{
	...
	Httprequestdeleteapi d=new Httprequestdeleteapi();
	...
	try
	{
		...
		else if(req.getParameter("reserve")!=null)
		{
			...
			else
			{
				...
				tl=g.getTraindetails();
				for(modifytrainbean t:tl)
				{				
					if((t.getTrainno()==trainno && t.getFromst().equalsIgnoreCase(fromst) && t.getTost().equalsIgnoreCase(tost) && t.getMon().equalsIgnoreCase(day))||(t.getTrainno()==trainno && t.getFromst().equalsIgnoreCase(fromst) && t.getTost().equalsIgnoreCase(tost) && t.getTues().equalsIgnoreCase(day)) ||
						(t.getTrainno()==trainno && t.getFromst().equalsIgnoreCase(fromst) && t.getTost().equalsIgnoreCase(tost) && t.getWed().equalsIgnoreCase(day)) ||(t.getTrainno()==trainno && t.getFromst().equalsIgnoreCase(fromst) && t.getTost().equalsIgnoreCase(tost) &&  t.getThur().equalsIgnoreCase(day))||
						(t.getTrainno()==trainno && t.getFromst().equalsIgnoreCase(fromst) && t.getTost().equalsIgnoreCase(tost) && t.getFri().equalsIgnoreCase(day)) ||(t.getTrainno()==trainno && t.getFromst().equalsIgnoreCase(fromst) && t.getTost().equalsIgnoreCase(tost) && t.getSat().equalsIgnoreCase(day)) || 
						(t.getTrainno()==trainno && t.getFromst().equalsIgnoreCase(fromst) && t.getTost().equalsIgnoreCase(tost) && t.getSun().equalsIgnoreCase(day)))
					  {
							if(classs.equals("AC"))
							{
